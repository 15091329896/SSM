...
public class PeopleDao extends SqlSessionUtil implements PeopleMapper {
	...
	@Override
	public List<People> getPeopleDynamic(String name) {
		fill();
		List<People> peoples = mapper.getPeopleDynamic(name);
		if(peoples == null) {
			System.out.println("获取到的值为null");
			return null;
		}
	...
	@Override
	public List<People> getPeopleDynamic2(People people) {
		fill();
		List<People> peoples = mapper.getPeopleDynamic2(people);
		if(peoples == null) {
			System.out.println("获取到的值为null");
			return null;
		}
	...
	@Override
	public List<People> getPeopleDynamic3(List<Integer> peopleIds) {
		fill();
		List<People> peoples = mapper.getPeopleDynamic3(peopleIds);
		if(peoples == null) {
			System.out.println("获取到的值为null");
			return null;
		}
